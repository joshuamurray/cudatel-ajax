...
var AjaxStream = function( env ){
    ...
    this.load = function( callback ){
        storage.file( "example.config.json").load( null, function( empty ){
            storage.file( "cudatel-ajax/config" ).load( null, function( config ){
                if( ! config ) storage.push( empty, function( saved ){
