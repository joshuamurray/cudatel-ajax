 ...
 * @constructor
 */
var AjaxTunnel = function( cudaTelHost, cudaTelUser ){
    var $this = this;
    ...
    this.saveSessionInFile = function( data, callback ){
        ...
        $this.cookieStore.save( user, data, callback );
    }
    ...
    this.wipeSessionInFile = function( sessionId, callback ){
        ...
        $this.cookieStore.wipe( user, function( wiped ){
    ...
    this.loadSessionInFile = function( callback ){
        ...
        $this.cookieStore.load( user, function( loaded ){
    ...
    this.afterAuthRequests = function( data, response, callback ){
        ...
        else console.log( response.request.uri.href );
        ...
        $this.responseSetCookie( data.data, response, function( saved ){
            if( ! saved ) return error( "Some issue with saving, or something." );
    ...
    this.afterValidRequest = function( data, response, callback ){
        ...
        console.log( "URL REQUESTED:", response.request.uri.href );
     ...
     */
    this.boot = function( cudaTelHost){
        $this.cudaTelHost = cudaTelHost;
        $this.cookieStore = new Storage( "../../storage/app/bps_sessions" );
        $this.defaultHead = {
     ...
     */
    $this.boot( cudaTelHost, cudaTelUser );
}
